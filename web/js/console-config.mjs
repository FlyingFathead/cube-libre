...
const DETAILS=Object.freeze({
  ...
  backup_cubes:['Backup cube reserve','Earned replacements remaining in this run. Read-only; collect every bonus piece or make an enabled flawless level exit to earn one.'],
  backup_cubes_enabled:['Backup cube rewards','Allow Backup Cube rewards and spending them during death reassembly. Default on; saved in this browser. Existing reserves and active protection are kept when disabled.'],
  backup_flawless_levels:['Flawless level Backup Cube reward','Award one Backup Cube for exiting a normal level through its portal with all 125 pieces intact. The count at the exit defines a flawless escape. Default on; session only.'],
  backup_invincibility_seconds:['Backup cube protection','Seconds of white-glow damage protection after spending a Backup Cube, default 4; range 0–30. Applies to the next use; session only. The leg clock still runs.'],
  bonus_before_final:['Bonus before final level','Add a bonus between levels 19–20 (49–50 in the original campaign). Default off; session only. A pending saved bonus remains playable after reload.'],
  ...
  mercy_seconds:['Mercy protection duration','Seconds without laser, shutter or boundary damage after a qualifying burst. Default 2; range 0–10. 0 disables new grace windows. Applies on the next trigger; session only.'],
